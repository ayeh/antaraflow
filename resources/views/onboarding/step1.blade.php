...
@section('content')
    <h2 class="text-xl font-bold text-slate-900 dark:text-white mb-2">{{ __('Complete Your Profile') }}</h2>
    <p class="text-sm text-slate-500 dark:text-slate-400 mb-6">{{ __("Let's start by setting up your profile.") }}</p>
