...
@section('content')
    <h2 class="text-xl font-bold text-slate-900 dark:text-white mb-2">{{ __('Set Up Your Workspace') }}</h2>
    <p class="text-sm text-slate-500 dark:text-slate-400 mb-6">{{ __('Configure your organization settings.') }}</p>

    <form method="POST" action="{{ route('onboarding.update', ['step' => 2]) }}">
        @csrf

        <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{{ __('Organization Name') }}</label>
        ...
        <div class="mb-4">
            <label for="timezone" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{{ __('Timezone') }}</label>
        ...
        <div class="mb-6">
            <label for="language" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{{ __('Language') }}</label>
