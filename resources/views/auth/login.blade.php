...
@section('content')
<h2 class="text-xl font-bold text-gray-900 mb-6">{{ __('Login') }}</h2>
...
<form method="POST" action="{{ route('login') }}" class="space-y-4">
    ...
    <button type="submit" class="btn-primary w-full text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">{{ __('Login') }}</button>
</form>
