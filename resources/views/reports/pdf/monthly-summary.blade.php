...
<head>
    <meta charset="UTF-8">
    <title>{{ __('Monthly Summary Report') }}</title>
    <style>
...
<body>
    <h1>{{ __('Monthly Summary Report') }}</h1>
    ...
    <div class="stat-grid">
        <div class="stat-cell">
            ...
            <div class="stat-label">{{ __('Meetings Held') }}</div>
        </div>
        <div class="stat-cell">
        ...
        <div class="stat-cell">
            ...
            <div class="stat-label">{{ __('Unique Attendees') }}</div>
        </div>
        <div class="stat-cell">
            <div class="stat-value">{{ $actionItemsCreated }}</div>
            <div class="stat-label">{{ __('Action Items Created') }}</div>
        </div>
    </div>
    ...
    <table>
        ...
        <tr>
            <td><strong>{{ __('Completion Rate') }}</strong></td>
            ...
            <tbody>
                @foreach($meetings as $meeting)
                    <tr>
                        ...
                        <td>{{ $meeting->duration_minutes ?? '—' }} {{ __('min') }}</td>
