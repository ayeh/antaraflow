...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Action Items') }}</h1>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 dark:bg-slate-700/50 border-b border-gray-200 dark:border-slate-700">
                            <tr>
                                ...
                                <th class="text-left px-6 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">{{ __('Meeting') }}</th>
                                ...
                                <tr>
                                    <td colspan="8" class="px-6 py-16 text-center">
                                        ...
                                        @if($selectedStatuses || $selectedPriorities || $assigneeFilter)
                                            <h3 class="mt-2 text-sm font-semibold text-gray-900 dark:text-white">{{ __('No items match your filters') }}</h3>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400"><a href="{{ route('action-items.dashboard') }}" class="text-violet-600 hover:underline">{{ __('Clear filters') }}</a> {{ __('to see all items.') }}</p>
                                        @else
                                            <h3 class="mt-2 text-sm font-semibold text-gray-900 dark:text-white">{{ __('No action items yet') }}</h3>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Action items from your meetings will appear here.') }}</p>
                                        @endif
                                    </td>
                                </tr>
                            @endforelse
