...
<body class="h-full bg-slate-200 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors">
    ...
    >
        ...
        <div id="appContentFrame" :class="sidebarCollapsed ? 'md:ml-[5rem]' : 'md:ml-[15.5rem]'" class="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-900 md:mt-3 md:[clip-path:inset(0_0_0_0_round_1rem_0_0_0)] transition-all duration-300 ease-in-out">
